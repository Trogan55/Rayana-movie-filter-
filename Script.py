class script(object):
    START_TXT = """ʜᴇʏ {}, {}
    
📌 ᴀᴅᴅ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴇɴᴊᴏʏ ɪɴꜱᴛᴀɴᴛ ᴍᴏᴠɪᴇ & ꜱᴇʀɪᴇꜱ ʀᴇꜱᴜʟᴛꜱ 🎬
▭▭▭▭▭▭▭▭▭▭▭▭▭
⚡ ꜱᴇᴀʀᴄʜ ᴀɴʏ ᴍᴏᴠɪᴇ ᴏʀ ꜱᴇʀɪᴇꜱ ɴᴀᴍᴇ  
📥 ɢᴇᴛ ꜰɪʟᴇꜱ ꜰᴀꜱᴛ • ꜱᴍᴀʀᴛ • ᴀᴜᴛᴏᴍᴀᴛɪᴄ  
▭▭▭▭▭▭▭▭▭▭▭▭▭
💎 ᴍᴀᴋᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴍᴏʀᴇ ᴘᴏᴡᴇʀꜰᴜʟ ᴡɪᴛʜ ᴍᴇ!

<blockquote>🫟 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://telegram.me/admnsprt_bot">[ᴍʀ•ᴅɪᴘᴀᴋ]</a></blockquote>"""
...
📝 ᴡᴀɴᴛ ᴛʜɪs ᴍᴏᴠɪᴇ/series?
⚜️ ᴄʟɪᴄᴋ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴛᴏ ʀᴇǫᴜᴇsᴛ ғʀᴏᴍ  ᴀᴅᴍɪɴ.
...
🎬 To find movies, please join our group 👇  
Search is not available in bot.

🚀 Join now & get your movie 🍿

<blockquote>आप केवल हमारे ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ पर ही ᴍᴏᴠɪᴇ sᴇᴀʀᴄʜ कर सकते हो ।</blockquote></b>"""
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @useeeername
...
ʜᴇʀᴇ’ꜱ ʏᴏᴜʀ ᴍᴏᴠɪᴇ, 🍿ɴᴏᴡ ᴇɴᴊᴏʏ .</i></b>"""
