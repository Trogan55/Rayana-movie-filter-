...
PICS = (environ.get('PICS', 'https://graph.org/file/e1a9d641cc00bd458b20a-615b64d72c7bf3f952.jpg https://graph.org/file/2ac435ba99a9e4c18d4dc-28446be0adc3ebe2ac.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5134768968').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1004454638822 -1004429387566').split()]  # Channel id for auto indexing (make sure bot is admin)
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002744582238')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003711873991')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/movies_foryour')  # Support group link (make sure bot is admin)
